...
const ShopDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
               ...
               <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-end gap-6">
                    ...
                    <div className="flex-1 text-white pb-2">
                        <div className="flex items-center gap-2 mb-2">
                            <span className="bg-primary/90 backdrop-blur-sm text-white px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wide border border-white/20">{shop.category}</span>
                            {shop.isVerified && (
                                <span className="flex items-center gap-1 bg-blue-500/80 backdrop-blur-sm px-2 py-1 rounded-lg text-xs font-bold border border-white/20">
                        ...
                        <div className="flex items-center gap-4 text-sm md:text-base font-medium text-slate-200">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden min-h-[500px]">
              ...
              <div className="flex border-b border-slate-100">
                  <button 
                    ...
                    className={`flex-1 py-5 text-center font-bold text-sm uppercase tracking-wider transition-colors border-b-2 ${activeTab === 'offers' ? 'border-primary text-primary' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                  >
                      <span className="flex items-center justify-center gap-2"><Grid size={18} /> Active Offers ({relatedOffers.length})</span>
                  </button>
                  <button 
                    onClick={() => setActiveTab('about')}
                    className={`flex-1 py-5 text-center font-bold text-sm uppercase tracking-wider transition-colors border-b-2 ${activeTab === 'about' ? 'border-primary text-primary' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                  >
                      <span className="flex items-center justify-center gap-2"><Info size={18} /> About & Contact</span>
                  </button>
              </div>

              <div className="p-6 md:p-10 bg-slate-50/50 min-h-[60vh]">
                  {activeTab === 'offers' && (
                          ...
                          {relatedOffers.length > 0 ? (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                              ...
                              <div className="flex flex-col items-center justify-center py-20 text-center">
                                  ...
                                  <p className="text-slate-500">This shop hasn't posted any offers yet. Check back later!</p>
                              </div>
                          )}
                          <div className="mt-12">
                      ...
                      <div className="animate-fadeIn grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                           <div className="lg:col-span-2 space-y-8">
                                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                                    <h3 className="text-xl font-bold text-slate-900 mb-4">About {shop.name}</h3>
                                    <p className="text-slate-600 leading-relaxed text-lg">{shop.description}</p>
                                </div>
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                                     ...
                                     <div className="grid md:grid-cols-2 gap-6 mb-8">
                                          <div className="flex items-start gap-4">
                                              ...
                                              <div>
                                                  ...
                                                  <p className="font-medium text-slate-700 leading-snug">{shop.address}, {shop.area}</p>
                                              </div>
                                          </div>
                                          <div className="flex items-start gap-4">
                                              ...
                                              <div>
                                                  ...
                                                  <p className="font-medium text-slate-700">{shop.contactNumber}</p>
                                              </div>
                                          </div>
                                          <div className="flex items-start gap-4">
                                              ...
                                              <div>
                                                  <p className="text-xs font-bold text-slate-400 uppercase mb-1">Opening Hours</p>
                                                  <p className="font-medium text-slate-700">Mon - Sat: 9:00 AM - 9:00 PM</p>
                                     ...
                                     <div className="w-full h-64 bg-slate-100 rounded-xl overflow-hidden border border-slate-200 relative group">
                                         ...
                                         <a 
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="absolute bottom-3 right-3 bg-white text-slate-900 text-xs font-bold px-3 py-2 rounded-lg shadow-md hover:bg-primary hover:text-white transition-colors flex items-center gap-1 opacity-90 hover:opacity-100"
                                         >
                           ...
                           <div className="lg:col-span-1 space-y-6">
                                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                                     <h3 className="text-sm font-bold text-slate-400 uppercase mb-4 tracking-wider">Connect Online</h3>
                                     <div className="flex flex-col gap-3">
                                          ...
                                          {shop.socialMedia?.website && (
                                              <a href={shop.socialMedia.website} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors group">
                                                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 group-hover:bg-slate-200"><Globe size={16} /></div>
                                                  <span className="font-medium text-slate-700">Visit Website</span>
                                              </a>
                                          )}
                                          {shop.socialMedia?.instagram && (
                                              <a href={shop.socialMedia.instagram} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-pink-50 transition-colors group">
                                                  <div className="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 group-hover:bg-pink-200"><Instagram size={16} /></div>
                                                  <span className="font-medium text-slate-700">Instagram</span>
                                              </a>
                                          )}
                                          {shop.socialMedia?.facebook && (
                                              <a href={shop.socialMedia.facebook} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-colors group">
                                                  <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 group-hover:bg-blue-200"><Facebook size={16} /></div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-100 md:hidden z-40 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
           <div className={`grid ${shop.socialMedia?.whatsapp ? 'grid-cols-2' : 'grid-cols-1'} gap-3`}>
                <a 
                    href={`tel:${shop.contactNumber}`}
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-teal-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary/20 active:scale-95 transition-transform"
                >
